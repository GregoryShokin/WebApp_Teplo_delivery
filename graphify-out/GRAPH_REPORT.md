...
## Corpus Check
- 1 files · ~3,805,367 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17132 nodes · 56653 edges · 672 communities (613 shown, 59 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 13075 edges (avg confidence: 0.62)
...
- [[_COMMUNITY_API-сервисы Settings service|API-сервисы: Settings service]]
...
- [[_COMMUNITY_Тесты Barter scenarios|Тесты: Barter scenarios]]
...
- [[_COMMUNITY_Тесты Bank payment status|Тесты: Bank payment status]]
...
- [[_COMMUNITY_API-сервисы Services|API-сервисы: Services]]
- [[_COMMUNITY_API-сервисы Payroll advance availability|API-сервисы: Payroll advance availability]]
...
- [[_COMMUNITY_API-модели Counterparty payable|API-модели: Counterparty payable]]
...
- [[_COMMUNITY_Тесты Rbac|Тесты: Rbac]]
...
- [[_COMMUNITY_API-сервисы Barter loan money|API-сервисы: Barter loan money]]
...
- [[_COMMUNITY_API-сервисы Iiko location|API-сервисы: Iiko location]]
...
- [[_COMMUNITY_Тесты Kassa cheque payout|Тесты: Kassa cheque payout]]
...
- [[_COMMUNITY_Тесты Admin payout split|Тесты: Admin payout split]]
- [[_COMMUNITY_Тесты Payroll|Тесты: Payroll]]
...
- [[_COMMUNITY_Тесты Warehouse supplier change|Тесты: Warehouse supplier change]]
...
- [[_COMMUNITY_Тесты Inventory audit|Тесты: Inventory audit]]
- [[_COMMUNITY_Спецификации Finance|Спецификации: Finance]]
- [[_COMMUNITY_Фронт-страницы Dishwashers|Фронт-страницы: Dishwashers]]
...
- [[_COMMUNITY_API-сервисы Transfer matching|API-сервисы: Transfer matching]]
...
- [[_COMMUNITY_API-схемы Dds|API-схемы: Dds]]
...
- [[_COMMUNITY_API-сервисы Advance iiko payout|API-сервисы: Advance iiko payout]]
...
- [[_COMMUNITY_Фронт-страницы Schedule|Фронт-страницы: Schedule]]
- [[_COMMUNITY_Миграции 0024 employee effective dated|Миграции: 0024 employee effective dated]]
...
- [[_COMMUNITY_Миграции 0074 payroll payouts|Миграции: 0074 payroll payouts]]
- [[_COMMUNITY_Миграции 0087 admin payroll permissions|Миграции: 0087 admin payroll permissions]]
...
- [[_COMMUNITY_API-джобы Employee sync job|API-джобы: Employee sync job]]
...
- [[_COMMUNITY_Миграции 0070 drop duplicate inventory|Миграции: 0070 drop duplicate inventory]]
- [[_COMMUNITY_Миграции 0077 payroll bank draft|Миграции: 0077 payroll bank draft]]
- [[_COMMUNITY_Миграции 0140 supplier prepayment|Миграции: 0140 supplier prepayment]]
- [[_COMMUNITY_Миграции 0163 kassa payin presets|Миграции: 0163 kassa payin presets]]
- [[_COMMUNITY_Миграции 0165 freelancer shift settle|Миграции: 0165 freelancer shift settle]]
- [[_COMMUNITY_Миграции 0167 sber safe payout|Миграции: 0167 sber safe payout]]
- [[_COMMUNITY_Миграции 0200 barter alloc link|Миграции: 0200 barter alloc link]]
- [[_COMMUNITY_Миграции 0204 alloc split line|Миграции: 0204 alloc split line]]
- [[_COMMUNITY_Миграции 0211 lease dds analytics|Миграции: 0211 lease dds analytics]]
- [[_COMMUNITY_Миграции 0212 lease accruals|Миграции: 0212 lease accruals]]
- [[_COMMUNITY_apps Session|apps: Session]]
- [[_COMMUNITY_Тесты Bank import sber mock|Тесты: Bank import sber mock]]
- [[_COMMUNITY_Тесты Bank import tbank mock|Тесты: Bank import tbank mock]]
- [[_COMMUNITY_Тесты Dds crud|Тесты: Dds crud]]
- [[_COMMUNITY_Деплой Init prod env|Деплой: Init prod env]]
- [[_COMMUNITY_Деплой Sync code to server|Деплой: Sync code to server]]
- [[_COMMUNITY_API-джобы Counterparty invoice sync job|API-джобы: Counterparty invoice sync job]]
- [[_COMMUNITY_API-джобы Sbis sync job|API-джобы: Sbis sync job]]
- [[_COMMUNITY_API-модели Iiko product|API-модели: Iiko product]]
- [[_COMMUNITY_API-модели Lease|API-модели: Lease]]
- [[_COMMUNITY_Тесты Conftest guard|Тесты: Conftest guard]]
- [[_COMMUNITY_tmp Build final iiko matches|tmp: Build final iiko matches]]
- [[_COMMUNITY_apps Init|apps: Init]]
- [[_COMMUNITY_apps Init|apps: Init]]
- [[_COMMUNITY_apps Init|apps: Init]]
- [[_COMMUNITY_apps Init|apps: Init]]
- [[_COMMUNITY_API-сервисы Init|API-сервисы: Init]]
- [[_COMMUNITY_apps Init|apps: Init]]
- [[_COMMUNITY_API-джобы Init|API-джобы: Init]]
- [[_COMMUNITY_business-docs Strategy worklog|business-docs: Strategy worklog]]
- [[_COMMUNITY_API-схемы Init|API-схемы: Init]]
- [[_COMMUNITY_Скрипты Agent worktree|Скрипты: Agent worktree]]
- [[_COMMUNITY_apps Bootstrap db|apps: Bootstrap db]]
- [[_COMMUNITY_API-скрипты Init|API-скрипты: Init]]
- [[_COMMUNITY_Скрипты Stand bank paid|Скрипты: Stand bank paid]]
- [[_COMMUNITY_Скрипты Stand deposit|Скрипты: Stand deposit]]
- [[_COMMUNITY_Скрипты Stand deposit state|Скрипты: Stand deposit state]]
- [[_COMMUNITY_Скрипты Stand reserve|Скрипты: Stand reserve]]
- [[_COMMUNITY_Скрипты Stand reset|Скрипты: Stand reset]]
- [[_COMMUNITY_API-роутеры Init|API-роутеры: Init]]
- [[_COMMUNITY_apps Tailwind config|apps: Tailwind config]]
- [[_COMMUNITY_Спецификации Database|Спецификации: Database]]
- [[_COMMUNITY_apps Pyproject|apps: Pyproject]]
- [[_COMMUNITY_business-docs Metrics tree|business-docs: Metrics tree]]
- [[_COMMUNITY_business-docs Payroll policy|business-docs: Payroll policy]]

## God Nodes (most connected - your core abstractions)
1. `async_session_factory()` - 888 edges
2. `PayrollConflictError` - 370 edges
3. `make_counterparty()` - 347 edges
4. `CurrentActor` - 327 edges
5. `PayrollNotFoundError` - 258 edges
6. `make_invoice()` - 240 edges
7. `HTTPException` - 236 edges
...
- **Жизненный цикл задачи: ветка → worktree → превью → деплой → уборка → граф** — claude_branch_naming_convention, claude_agent_worktree_script, claude_preview_port_slot_formula, claude_deploy_procedure, claude_mandatory_cleanup, claude_graph_update_after_deploy [EXTRACTED 1.00]
- **Восстановление после гонки с чужим мержем** — claude_manifest_written_from_disk_state, claude_fix_head_before_after_run, claude_pointwise_reindex_via_extract, claude_verify_by_symbols_not_numbers, claude_node_loss_not_always_error, claude_line_shift_false_loss [EXTRACTED 1.00]
- **Сборка превью-стенда: учётка, скрипт, переменные, заглушка iiko** — claude_single_preview_admin_credentials, claude_seed_preview_admin_script, claude_preview_env_switches, claude_iiko_stub_prevents_uvicorn_kill, claude_no_production_keys_on_preview [EXTRACTED 1.00]
...
## Communities (672 total, 59 thin omitted)
...
### Community 1 - "API: Схемы ЗП и курьеров"
Cohesion: 0.01
...
### Community 4 - "Фронт: Контрагенты и накладные"
Cohesion: 0.02
Nodes (197): addCollectionSource(), addRoutingRule(), archiveCounterparty(), autoSettleBarter(), BankPrepaymentDraftPayload, BarterDetail, BarterInvoice, BarterSettlementView (+189 more)
...
### Community 6 - "Фронт-библиотеки: Lib"
Cohesion: 0.02
Nodes (155): CounterpartyCard, createBankPrepaymentDraft(), createPrepayment(), getIikoSuppliers(), CreateTab, AdvanceForm(), amountOf(), amountStr() (+147 more)

### Community 7 - "API: Синхронизация курьеров iiko"
Cohesion: 0.06
Nodes (151): alias, Any, AsyncSession, Body, CurrentActor, date, Depends, Employee (+143 more)

### Community 8 - "Фронт-страницы: Lib"
Cohesion: 0.02
...
### Community 9 - "API: Банковский шедулер и синк"
Cohesion: 0.05
Nodes (110): _bank_operation_from_normalized(), _update_bank_operation(), alias, Exception, Query, Any, date, AccountMeta (+102 more)

### Community 10 - "Тесты: сотрудники и увольнение"
Cohesion: 0.04
Nodes (126): date, Decimal, Employee, MonkeyPatch, create_employee(), _date_years_ago(), dismiss_employee(), patch_employee() (+118 more)

### Community 11 - "Фронт-библиотеки: Dds"
Cohesion: 0.03
Nodes (116): CounterpartyDirectoryItem, createCounterparty(), DdsRoute(), DdsRouteProps, readStoredDdsTab(), renderTab(), KassaTargetsDialog(), Stat() (+108 more)

### Community 12 - "Фронт-компоненты: Deposits"
Cohesion: 0.03
Nodes (114): Курьеры — оценки админов (MVP), 14 критериев courier_evaluation_criterion с баллами, Депозитный счёт курьера: цель 5000₽, удержания 500/200, CourierDepositsRoute(), CourierDepositsRouteProps, CourierOperationDialog(), depositGroupRank(), emptyTitle() (+106 more)

### Community 13 - "Тесты: правка оплаченных накладных"
Cohesion: 0.03
Nodes (131): AsyncSession, IikoProduct, async_sessionmaker, AsyncSession, async_sessionmaker, AsyncSession, Any, Employee (+123 more)

### Community 14 - "API-сервисы: Payroll advance service"
Cohesion: 0.05
Nodes (127): AdvanceAvailability, alias, AsyncSession, CurrentActor, date, Depends, Employee, get_current_actor (+119 more)

### Community 15 - "API: Калькулятор ЗП"
Cohesion: 0.06
Nodes (128): Any, AsyncSession, AttendanceEntry, date, Decimal, Employee, PayrollAdjustment, PayrollLine (+120 more)

### Community 16 - "Фронт: Касса, ДДС, контрагенты"
Cohesion: 0.02
Nodes (109): cancelKassaAdvancePermission(), CardTransaction, Cheque, ChequeAllocation, ChequeLine, ChequeLinePayload, createCheque(), CreateChequePayload (+101 more)

### Community 17 - "API: ЗП-раннер и авансы"
Cohesion: 0.18
Nodes (127): AdvanceRecoveryDeferralRequest, alias, Any, AsyncSession, CurrentActor, date, DeferredAuditCharge, Depends (+119 more)

### Community 18 - "Тесты: ЗП и авторизация"
Cohesion: 0.04
Nodes (81): create_app(), CurrentUser, AccumulationFundAccount, AccumulationFundTransaction, AppSetting, Decimal, DeferredAuditCharge, DepositAccount (+73 more)
...
### Community 20 - "Тесты: Payroll admin"
Cohesion: 0.05
...
### Community 21 - "API-сервисы: Vacation service"
Cohesion: 0.06
Nodes (100): AsyncSession, CurrentActor, date, Depends, get_current_actor, get_session, Query, User (+92 more)

### Community 22 - "API: Роутеры кассы и чеков"
Cohesion: 0.08
Nodes (112): AsyncSession, Counterparty, CurrentActor, date, datetime, DdsArticle, Depends, get_current_actor (+104 more)

### Community 23 - "Тесты: расчёт строк ЗП"
Cohesion: 0.09
...
### Community 24 - "API: Роутеры бартера и матчинга"
Cohesion: 0.09
Nodes (108): alias, Any, AsyncSession, CurrentActor, Decimal, Depends, get_current_actor, get_session (+100 more)

### Community 25 - "API: Роутер ДДС и черновики"
Cohesion: 0.07
...
### Community 26 - "API: Роутеры банка"
Cohesion: 0.07
Nodes (103): Any, AsyncSession, CurrentActor, date, Depends, get_current_actor, get_session, UUID (+95 more)

### Community 27 - "API: Должности и доступы"
Cohesion: 0.09
Nodes (99): Any, AsyncSession, CurrentActor, Depends, Employee, get_current_actor, get_session, UUID (+91 more)

### Community 28 - "API: Ревизии и инвентаризация"
Cohesion: 0.08
...
### Community 31 - "Тесты: «Новый платёж» и Сейф"
Cohesion: 0.06
Nodes (93): Account, async_sessionmaker, AsyncSession, async_sessionmaker, AsyncSession, CashflowTransaction, DdsArticle, Employee (+85 more)
...
### Community 33 - "Тесты: Counterparties"
Cohesion: 0.05
Nodes (87): Counterparty, async_sessionmaker, AsyncSession, async_sessionmaker, AsyncSession, async_sessionmaker, AsyncSession, EmailInvoiceIntake (+79 more)

### Community 34 - "API-сервисы: Payroll admin"
Cohesion: 0.06
Nodes (90): Any, AsyncSession, date, Decimal, Employee, PayrollLine, PayrollPeriod, PayrollRun (+82 more)

### Community 35 - "Тесты: Invoice sync"
Cohesion: 0.07
Nodes (90): Any, async_sessionmaker, AsyncSession, UUID, async_sessionmaker, AsyncSession, cloud_invoice_docs(), _cloud_item() (+82 more)

### Community 36 - "Фронт: Учёт, ДЗ/КЗ, права"
Cohesion: 0.03
Nodes (70): AccountingItem, AccountingList, ALLOCATION_LABEL, BalanceList, BalancesSection(), CounterpartyBalance, date, DocumentAllocationRef (+62 more)

### Community 37 - "API-сервисы: Cheque"
Cohesion: 0.06
...
### Community 39 - "Тесты: Payroll"
Cohesion: 0.04
Nodes (31): Any, AttendanceEntry, UUID, adjustment_category(), app_with_payroll_adjustment_session(), AttendanceLoaderFakeScalarResult, AttendanceLoaderFakeSession, DeferredChargeScalarResult (+23 more)

### Community 40 - "API: Роутер надбавок"
Cohesion: 0.22
Nodes (87): AllowanceAssignment, AllowanceAssignmentRead, alias, AsyncSession, CurrentActor, date, Decimal, Depends (+79 more)

### Community 41 - "API-сервисы: Warehouse invoices"
Cohesion: 0.07
Nodes (84): Any, AsyncSession, date, datetime, DdsArticle, Decimal, IikoProduct, InvoiceLineItem (+76 more)

### Community 42 - "Фронт: Депозиты"
Cohesion: 0.04
...
### Community 43 - "API: Расчёт внештатных смен"
Cohesion: 0.09
Nodes (82): Any, AsyncSession, date, Decimal, Employee, PayrollPeriod, UUID, Any (+74 more)

### Community 44 - "API: Реестр контрагентов"
Cohesion: 0.07
...
### Community 45 - "Тесты: статусы банк-платежей"
Cohesion: 0.06
Nodes (77): Any, AsyncSession, CounterpartyPaymentDraft, date, Decimal, SupplierInvoice, UUID, Account (+69 more)

### Community 46 - "Тесты: Payroll pool payout"
Cohesion: 0.07
Nodes (77): Decimal, Namespace, UUID, AsyncSession, Decimal, UUID, async_sessionmaker, AsyncSession (+69 more)

### Community 47 - "Интеграция Mail.ru: почтовый ящик"
Cohesion: 0.07
Nodes (80): EmailMessage, IMAP4_SSL, ArgumentParser, Connection, Message, Namespace, Path, Row (+72 more)

### Community 48 - "API: Выплаты ЗП"
Cohesion: 0.09
Nodes (79): Any, AsyncSession, BankClient, date, Decimal, PayrollPeriod, PayrollRun, UUID (+71 more)

### Community 49 - "Тесты: Dds cashflow classify"
Cohesion: 0.06
...
### Community 50 - "API-сервисы: Shift ledger"
Cohesion: 0.09
Nodes (73): alias, AsyncSession, CurrentActor, date, Depends, get_current_actor, get_session, Query (+65 more)

### Community 51 - "Тесты: Kassa cheques"
Cohesion: 0.08
Nodes (71): DdsArticle, async_sessionmaker, AsyncSession, TestClient, async_sessionmaker, AsyncSession, async_sessionmaker, AsyncSession (+63 more)

### Community 52 - "API-роутеры: Inventory"
Cohesion: 0.23
Nodes (73): alias, Any, AsyncSession, CurrentActor, date, Decimal, Depends, get_current_actor (+65 more)

### Community 53 - "API-сервисы: Services"
Cohesion: 0.08
Nodes (70): AsyncSession, AttendanceEntry, date, Any, AsyncSession, date, Decimal, Any (+62 more)

### Community 54 - "API-роутеры: Locations"
Cohesion: 0.08
Nodes (69): AsyncSession, Counterparty, date, Depends, get_session, Location, LocationLease, UUID (+61 more)

### Community 55 - "API-роутеры: Payroll adjustments"
Cohesion: 0.12
Nodes (71): alias, Any, AsyncSession, CurrentActor, date, Depends, Employee, get_current_actor (+63 more)

### Community 56 - "API-сервисы: Deposit service"
Cohesion: 0.07
Nodes (70): Any, AsyncSession, UUID, Any, AsyncSession, CourierDepositTransaction, date, datetime (+62 more)

### Community 57 - "API-сервисы: Payroll payments"
Cohesion: 0.10
Nodes (70): Any, AsyncSession, date, Decimal, PayrollLine, PayrollPayment, PayrollRun, UUID (+62 more)

### Community 58 - "Тесты: Dz kz canon"
Cohesion: 0.08
...
### Community 59 - "API-сервисы: Warehouse payments"
Cohesion: 0.09
Nodes (67): Any, AsyncSession, date, Decimal, SupplierInvoice, UUID, async_sessionmaker, AsyncSession (+59 more)

### Community 60 - "API: ORM-модели ЗП, ДДС, КЗ"
Cohesion: 0.05
Nodes (65): Base, Counterparty, Account, BankOperation, CashflowTransaction, ClassificationRule, CounterpartyAlias, DdsArticle (+57 more)

### Community 61 - "Спецификации: Decisions"
Cohesion: 0.06
...
### Community 62 - "API-сервисы: Payroll runner"
Cohesion: 0.10
Nodes (65): Ночной свип «окна заработанного» для авансов производственникам (повар/кассир)., refresh_production_advance_window_job(), AccumulationFundAccount, Any, AppSetting, AsyncSession, AttendanceEntry, date (+57 more)

### Community 63 - "API: Касса — выплаты"
Cohesion: 0.09
Nodes (63): Any, AsyncSession, CashflowTransaction, date, DdsArticle, Decimal, Employee, SalaryAdvance (+55 more)

### Community 64 - "Тесты: Barter money settlement"
Cohesion: 0.08
Nodes (64): Wallet, async_sessionmaker, AsyncSession, Decimal, async_sessionmaker, AsyncSession, make_wallet(), _make_loan() (+56 more)

### Community 65 - "API-схемы: Kassa"
Cohesion: 0.03
...
### Community 66 - "API-сервисы: Deferred audit charge service"
Cohesion: 0.09
...
### Community 67 - "API-сервисы: Shift schedule service"
Cohesion: 0.10
...
### Community 68 - "API-схемы: Employees"
Cohesion: 0.03
...
### Community 69 - "API-сервисы: Counterparty iiko payment"
Cohesion: 0.07
...
### Community 70 - "Тесты: Shift schedule"
Cohesion: 0.10
Nodes (49): Any, CurrentActor, date, Employee, EmployeeRoleAssignment, MonkeyPatch, ScheduledShift, ShiftLedgerEntry (+41 more)

### Community 71 - "API-роутеры: Accumulation fund"
Cohesion: 0.11
Nodes (61): AccumulationFundAccount, AccumulationFundTransaction, Any, AppSetting, AsyncSession, Body, CurrentActor, date (+53 more)

### Community 72 - "API-сервисы: Counterparties"
Cohesion: 0.08
Nodes (59): Any, AsyncSession, BankOperation, datetime, Decimal, SupplierInvoice, UUID, async_sessionmaker (+51 more)

### Community 73 - "API-сервисы: Counterparties"
Cohesion: 0.06
...
### Community 75 - "Интеграции: Export orders delivery"
Cohesion: 0.14
...
### Community 76 - "API-роутеры: Employees"
Cohesion: 0.40
Nodes (60): alias, Body, date, datetime, Decimal, DepositAccount, EmployeeChangeEvent, EmployeeDismissalReason (+52 more)

### Community 77 - "Тесты: Employee payouts"
Cohesion: 0.09
Nodes (57): AsyncSession, BankClient, date, EmployeePayout, UUID, async_sessionmaker, AsyncSession, Decimal (+49 more)

### Community 78 - "API-сервисы: Iiko sync"
Cohesion: 0.11
Nodes (58): Any, AsyncSession, date, datetime, Employee, UUID, is_target_position(), _active_substitute_target_positions() (+50 more)

### Community 79 - "Тесты: Payroll advance service"
Cohesion: 0.14
...
### Community 83 - "Тесты: Plan fact"
Cohesion: 0.12
Nodes (50): Any, AppSetting, date, datetime, Decimal, Employee, MonkeyPatch, PayrollForecastRun (+42 more)

### Community 84 - "API-сервисы: Counterparty payments"
Cohesion: 0.10
Nodes (55): Any, AsyncSession, BankClient, Counterparty, CounterpartyPaymentDraft, Decimal, SupplierInvoice, UUID (+47 more)

### Community 85 - "Тесты: Sbis sync"
Cohesion: 0.13
...
### Community 86 - "API-сервисы: Email invoice ingest"
Cohesion: 0.09
Nodes (52): AsyncSession, date, Decimal, EmailInvoiceIntake, FetchedAttachment, RecognizedInvoice, Settings, SupplierInvoice (+44 more)

### Community 87 - "API-сервисы: Supplier prepayments"
Cohesion: 0.10
...
### Community 88 - "Интеграции: Export ops"
Cohesion: 0.13
Nodes (55): IikoHTTPError, Any, date, datetime, IikoClient, Path, active_rows(), add_cost_metrics() (+47 more)

### Community 89 - "API-сервисы: Counterparty invoice sync"
Cohesion: 0.07
Nodes (53): Any, AsyncSession, date, IikoProduct, ModuleType, Path, SupplierInvoice, UUID (+45 more)

### Community 90 - "API-сервисы: Payments aggregator"
Cohesion: 0.08
Nodes (51): Any, AsyncSession, DdsArticle, AsyncSession, Decimal, UUID, _allowed_flows(), build_new_payment_context() (+43 more)

### Community 91 - "API-сервисы: Invoice recognition"
Cohesion: 0.07
...
### Community 92 - "Интеграции: Build inventory results"
Cohesion: 0.12
Nodes (53): Any, date, Decimal, IikoClient, Path, build_inventory_rows(), build_pnl_rows(), build_unclassified_rows() (+45 more)

### Community 93 - "Интеграции: Export sales day hour"
Cohesion: 0.12
Nodes (46): Any, date, Path, aggregate_by_hour(), aggregate_by_weekday(), average_check(), base_metrics(), build_daily() (+38 more)

### Community 94 - "API-скрипты: Import legacy payroll"
Cohesion: 0.11
Nodes (52): AccumulationFundAccount, Any, AsyncSession, date, datetime, Decimal, Employee, Path (+44 more)

### Community 95 - "API-сервисы: Cheque payout push"
Cohesion: 0.06
Nodes (47): Any, CourierDepositTransaction, date, Decimal, UUID, Any, AsyncSession, DdsArticle (+39 more)

### Community 96 - "Тесты: сплит операций и дедуп"
Cohesion: 0.11
...
### Community 97 - "API-сервисы: Payroll config"
Cohesion: 0.14
...
### Community 102 - "Спецификации: Finance"
Cohesion: 0.06
...
### Community 103 - "API-сервисы: Kpi service"
Cohesion: 0.12
Nodes (47): Any, AsyncSession, CourierScheduleEntry, CourierShiftMatch, date, datetime, Decimal, DeliveryOrder (+39 more)

### Community 104 - "Тесты: Fixed assets"
Cohesion: 0.10
Nodes (46): AsyncSession, date, Decimal, FixedAsset, UUID, async_sessionmaker, AsyncSession, date (+38 more)

### Community 105 - "API-сервисы: Revenue forecast service"
Cohesion: 0.11
Nodes (41): lifespan(), AsyncSession, Depends, get_session, AsyncSession, Employee, UUID, AsyncSession (+33 more)

### Community 106 - "apps: Scheduler"
Cohesion: 0.09
Nodes (44): _account_for_number(), _account_for_operation(), archive_expired_freelancer_cards(), _bank_sync_providers(), _claim_seed_account(), _client_for_provider(), _create_invalid_credentials_case(), _default_sync_period() (+36 more)

### Community 107 - "API-сервисы: Warehouse invoice push"
Cohesion: 0.08
Nodes (45): OpenerDirector, AsyncSession, OpenerDirector, SupplierInvoice, UUID, test_extract_document_id_and_business_error(), iiko_auth_token(), iiko_opener() (+37 more)

### Community 108 - "API: Назначения и таксономия штата"
Cohesion: 0.21
Nodes (44): Any, AsyncSession, date, Employee, EmployeeRoleAssignment, UUID, _active_on(), add_role() (+36 more)

### Community 109 - "Исследования: Classify cashflow"
Cohesion: 0.15
...
### Community 110 - "API-роутеры: Dds"
Cohesion: 0.75
Nodes (45): alias, AllocationMoveRequest, CashflowTransaction, date, DdsArticle, BackgroundTasks, BankOperation, BankSyncRequest (+37 more)

### Community 111 - "Тесты: Kassa cheque refund"
Cohesion: 0.17
...
### Community 115 - "Тесты: Kassa target stage3"
Cohesion: 0.11
Nodes (43): async_sessionmaker, AsyncSession, DdsArticle, Employee, SafeAllocation, SalaryAdvance, UUID, _counterparty() (+35 more)

### Community 116 - "Тесты: Shift cost estimate"
Cohesion: 0.14
Nodes (32): Any, AppSetting, CurrentActor, date, Decimal, Employee, MonkeyPatch, PayrollForecastRun (+24 more)

### Community 117 - "Прочее: CLAUDE"
Cohesion: 0.07
Nodes (44): apps/docker-compose.agent-b.yml — изолированный стек агента, scripts/agent-worktree.sh add, Критерий безопасного удаления ветки, Имена ветвей feat/ fix/ deploy/, Работа с ветками и worktree — как не плодить хаос, Закоммитить обновлённый граф в git, Деплой: --ff-only в main → push → прод, Истина — в файлах, граф — снимок (+36 more)

### Community 118 - "Интеграции: Export revenue by direction"
Cohesion: 0.14
Nodes (43): Any, date, IikoClient, Namespace, Path, add_metrics(), aggregate_direction_rows(), aggregate_opiu() (+35 more)

### Community 119 - "Интеграции: Payment order bot"
Cohesion: 0.13
...
### Community 120 - "Фронт-компоненты: Settings widgets"
Cohesion: 0.11
...
### Community 121 - "Тесты: Iiko payment verify"
Cohesion: 0.13
...
### Community 122 - "API-сервисы: Position registry"
Cohesion: 0.07
...
### Community 123 - "Тесты: Accumulation fund admin"
Cohesion: 0.12
...
### Community 131 - "Тесты: Freelancer temp cards"
Cohesion: 0.14
...
### Community 140 - "Фронт-страницы: Adjustments"
Cohesion: 0.07
...
### Community 141 - "Тесты: Inventory audit"
Cohesion: 0.19
...
### Community 142 - "API-модели: Models"
Cohesion: 0.07
Nodes (28): Base, DeclarativeBase, AgentAction, AgentRun, DataSource, ParsedDocument, SourceCredential, SourceDocument (+20 more)

### Community 143 - "Интеграции: Build cashflow"
Cohesion: 0.17
Nodes (38): Any, date, Namespace, Path, aggregate_counterparties(), build(), counterparty_key(), direction() (+30 more)

### Community 144 - "API-скрипты: Import staff from payroll"
Cohesion: 0.15
Nodes (37): Any, AsyncSession, date, datetime, Decimal, Employee, Namespace, Path (+29 more)

### Community 145 - "API-сервисы: Iiko sync"
Cohesion: 0.12
Nodes (37): Element, Exception, ModuleType, Path, fetch_iiko_attendance_xml(), fetch_iiko_employee_roles(), _build_iiko_employee_deleted_xml(), _build_iiko_employee_roles_update_xml() (+29 more)

### Community 146 - "API-сервисы: Deposit schedule"
Cohesion: 0.12
Nodes (35): Any, AsyncSession, Decimal, UUID, async_sessionmaker, AsyncSession, Employee, PayrollRun (+27 more)

### Community 147 - "API-сервисы: Position service"
Cohesion: 0.14
...
### Community 148 - "Тесты: Kassa invoice mirror"
Cohesion: 0.15
...
### Community 153 - "Тесты: Lease accruals"
Cohesion: 0.06
...
### Community 157 - "API-сервисы: Cashflow classify"
Cohesion: 0.10
Nodes (32): Any, AsyncSession, CashflowTransaction, UUID, Wallet, AsyncSession, date, DdsArticle (+24 more)

### Community 158 - "Тесты: Operation split card match"
Cohesion: 0.16
Nodes (33): async_sessionmaker, AsyncSession, TestClient, UUID, _alloc_count(), _card_fixture(), _classify_url(), _headers() (+25 more)

### Community 159 - "Тесты: Payroll advance bank"
Cohesion: 0.21
Nodes (33): async_sessionmaker, AsyncSession, CashflowTransaction, Decimal, MonkeyPatch, SalaryAdvance, UUID, Wallet (+25 more)

### Community 160 - "Интеграции: Payment parsers"
Cohesion: 0.14
...
### Community 161 - "API-роутеры: Positions"
Cohesion: 0.32
...
### Community 165 - "API-сервисы: Client"
Cohesion: 0.10
...
### Community 180 - "API-сервисы: Iiko invoice cloud"
Cohesion: 0.13
Nodes (29): OpenerDirector, datetime, OpenerDirector, test_endpoint_mapping(), iiko_cloud_call(), Синхронный Cloud-вызов (исполнять в треде): auth (если ``token`` не передан) + P, cancel_invoice(), create_invoice() (+21 more)

### Community 181 - "Тесты: Barter loan bank draft"
Cohesion: 0.12
Nodes (29): async_sessionmaker, AsyncSession, SupplierInvoice, UUID, _headers(), _loan_invoice(), Оплата бартерного займа безналом и выбор банка-плательщика в черновике.  Правило, Без явного канала черновик выписывается на Т-Банк — прежнее поведение не изменил (+21 more)

### Community 182 - "Тесты: Warehouse push"
Cohesion: 0.22
...
### Community 183 - "Тесты: Inventory audit"
Cohesion: 0.19
...
### Community 188 - "API-сервисы: Payroll advance availability"
Cohesion: 0.18
Nodes (29): AsyncSession, date, Decimal, Employee, PayrollPeriod, UUID, _already_advanced_in_period(), available_to_advance() (+21 more)

### Community 189 - "Тесты: Models"
Cohesion: 0.09
...
### Community 190 - "Тесты: Payroll payouts"
Cohesion: 0.28
Nodes (28): async_sessionmaker, AsyncSession, Decimal, MonkeyPatch, SafeAllocation, UUID, Wallet, create_actor_user() (+20 more)

### Community 191 - "API-сервисы: Iiko inventory"
Cohesion: 0.15
Nodes (27): Any, AsyncSession, date, ModuleType, Any, AsyncSession, _clean(), _decimal() (+19 more)

### Community 192 - "API-модели: Counterparty payable"
Cohesion: 0.07
...
### Community 193 - "API-сервисы: Evaluation service"
Cohesion: 0.20
...
### Community 195 - "Тесты: Warehouse routes phase4"
Cohesion: 0.24
...
### Community 196 - "Тесты: Access control api"
Cohesion: 0.32
...
### Community 197 - "Исследования: Couriers sheets discovery"
Cohesion: 0.10
...
### Community 198 - "business-docs: Portrait"
Cohesion: 0.09
...
### Community 203 - "Тесты: Payroll pool allocate"
Cohesion: 0.25
...
### Community 207 - "Тесты: Requisites control key"
Cohesion: 0.13
...
### Community 208 - "API-сервисы: Employee change events"
Cohesion: 0.25
...
### Community 214 - "Тесты: Deposit bank draft"
Cohesion: 0.20
...
### Community 215 - "Тесты: Deposit full cycle"
Cohesion: 0.23
...
### Community 216 - "Тесты: Payroll payments"
Cohesion: 0.32
...
### Community 217 - "API-сервисы: Dismissal reconciliation service"
Cohesion: 0.18
...
### Community 223 - "Тесты: Realtime draft settlement"
Cohesion: 0.30
...
### Community 224 - "API-сервисы: Banking"
Cohesion: 0.19
...
### Community 232 - "Тесты: Payroll unfinalize"
Cohesion: 0.26
Nodes (22): Any, async_sessionmaker, AsyncSession, Decimal, DepositAccount, Employee, MonkeyPatch, PayrollPeriod (+14 more)

### Community 233 - "Фронт-страницы: Schedule"
Cohesion: 0.12
...
### Community 234 - "Фронт-страницы: Schedule"
Cohesion: 0.13
...
### Community 236 - "API-роутеры: Payroll config"
Cohesion: 0.42
...
### Community 237 - "API-сервисы: Staff access"
Cohesion: 0.32
...
### Community 240 - "API-сервисы: Payroll config"
Cohesion: 0.50
...
### Community 243 - "Тесты: Refund resync"
Cohesion: 0.21
...
### Community 245 - "Тесты: Substitution service"
Cohesion: 0.19
...
### Community 246 - "Тесты: Absorb auto classified prebooked"
Cohesion: 0.26
...
### Community 247 - "Тесты: Payroll advances api"
Cohesion: 0.36
...
### Community 253 - "Тесты: Amount split"
Cohesion: 0.21
...
### Community 254 - "Тесты: Cashier allowance resolver"
Cohesion: 0.24
...
### Community 255 - "Тесты: Cloud shift webhook"
Cohesion: 0.33
...
### Community 256 - "Тесты: Reconcile prebooked"
Cohesion: 0.27
...
### Community 257 - "Фронт-страницы: Schedule"
Cohesion: 0.16
...
### Community 258 - "Тесты: Audit canon gaps"
Cohesion: 0.25
...
### Community 259 - "Тесты: Kassa pending cheque"
Cohesion: 0.28
...
### Community 260 - "Тесты: Access rights backend guards"
Cohesion: 0.40
...
### Community 261 - "API-сервисы: Imap client"
Cohesion: 0.20
...
### Community 262 - "Тесты: Schedule service"
Cohesion: 0.19
...
### Community 263 - "Тесты: Webhook account operation"
Cohesion: 0.36
...
### Community 264 - "Документация: Deposit full cycle plan"
Cohesion: 0.14
...
### Community 265 - "API-схемы: Payroll config"
Cohesion: 0.15
...
### Community 270 - "API-сервисы: Payroll rounding"
Cohesion: 0.21
...
### Community 271 - "Тесты: Warehouse numbering"
Cohesion: 0.25
...
### Community 272 - "Тесты: Employees"
Cohesion: 0.15
Nodes (6): Any, FakeExecuteResult, FakeScalarResult, present_from/present_to: активные всегда + «в увольнении» с ФАКТ. табелем., test_list_employees_present_window_status_and_worked_shift(), test_list_employees_without_trailing_slash_returns_200()

### Community 273 - "Тесты: Sber token refresh"
Cohesion: 0.26
...
### Community 274 - "Деплой: Build integrations env"
Cohesion: 0.25
...
### Community 283 - "Прочее: WORK IN PROGRESS"
Cohesion: 0.15
...
### Community 284 - "API-схемы: Vacations"
Cohesion: 0.17
...
### Community 285 - "API-сервисы: Ip card requisites"
Cohesion: 0.17
...
### Community 286 - "API-сервисы: Iiko directory"
Cohesion: 0.23
...
### Community 287 - "Тесты: Kassa cheque payout"
Cohesion: 0.43
Nodes (14): async_sessionmaker, AsyncSession, _card_op(), _mock_iiko(), _payouts(), Проводка прочих расходов чека в iiko изъятием (addPayOut): резолв типа по структ, test_idempotent_no_double_post(), test_iiko_error_marks_failed_without_raising() (+6 more)

### Community 288 - "Тесты: Operation split api counterparty"
Cohesion: 0.32
...
### Community 289 - "Тесты: Shift matching"
Cohesion: 0.28
...
### Community 290 - "Тесты: Bank webhook poll dedup"
Cohesion: 0.32
...
### Community 291 - "Тесты: Payroll advance stale run"
Cohesion: 0.31
Nodes (14): async_sessionmaker, AsyncSession, datetime, Employee, PayrollPeriod, PayrollRun, SalaryAdvance, _advance() (+6 more)

### Community 292 - "Тесты: Admin payout split"
Cohesion: 0.31
Nodes (13): async_sessionmaker, AsyncSession, PayrollRunEvent, Set the run-level cash portion of the payroll and the cash wallet it is paid fro, set_run_payout_cash(), _event(), После удаления банк должен получить новый id, а не идемпотентно вернуть старый D, test_create_run_draft_uses_run_account_part_for_one_bank_draft() (+5 more)

### Community 293 - "Тесты: Payroll"
Cohesion: 0.34
...
### Community 294 - "Спецификации: Tbank"
Cohesion: 0.16
...
### Community 295 - "API-сервисы: Payroll payout allocation"
Cohesion: 0.24
...
### Community 296 - "Тесты: Invoice paid push"
Cohesion: 0.29
...
### Community 297 - "Тесты: Warehouse supplier change"
Cohesion: 0.34
...
### Community 298 - "Тесты: Deposit rbac"
Cohesion: 0.48
...
### Community 302 - "Тесты: Deposit service"
Cohesion: 0.26
...
### Community 303 - "Тесты: Dds schema"
Cohesion: 0.26
...
### Community 304 - "Тесты: Inventory audit"
Cohesion: 0.21
...
### Community 305 - "Спецификации: Finance"
Cohesion: 0.19
...
### Community 306 - "Фронт-страницы: Dishwashers"
Cohesion: 0.21
...
### Community 313 - "Тесты: Warehouse supplier change routes"
Cohesion: 0.41
...
### Community 314 - "Спецификации: Server api endpoints"
Cohesion: 0.18
...
### Community 315 - "Спецификации: Dds"
Cohesion: 0.20
...
### Community 317 - "Документация: Features"
Cohesion: 0.30
...
### Community 318 - "Исследования: Report"
Cohesion: 0.20
...
### Community 319 - "API-модели: Fixed asset"
Cohesion: 0.17
...
### Community 320 - "Миграции: 0009 normalize payroll categories"
Cohesion: 0.36
...
### Community 323 - "Деплой: Docker compose prod"
Cohesion: 0.29
...
### Community 324 - "disign: Раскадровка промо"
Cohesion: 0.20
...
### Community 325 - "Документация: Access rights matrix"
Cohesion: 0.22
...
### Community 326 - "API-модели: Kassa"
Cohesion: 0.18
...
### Community 327 - "apps: Docker compose"
Cohesion: 0.29
...
### Community 328 - "API-сервисы: Transfer matching"
Cohesion: 0.51
...
### Community 329 - "API-сервисы: Deposit payout"
Cohesion: 0.29
...
### Community 330 - "Тесты: Dds transaction classify"
Cohesion: 0.42
...
### Community 333 - "Документация: Deposit full cycle plan"
Cohesion: 0.20
...
### Community 334 - "Тесты: Payroll payout allocation"
Cohesion: 0.29
...
### Community 335 - "Тесты: Lookup rate"
Cohesion: 0.51
...
### Community 336 - "Тесты: Inventory audit"
Cohesion: 0.36
...
### Community 337 - "Тесты: Sber payout channel"
Cohesion: 0.27
...
### Community 338 - "Миграции: 0061 rbac permissions"
Cohesion: 0.36
...
### Community 339 - "Миграции: 0068 revision permissions"
Cohesion: 0.42
...
### Community 340 - "apps: Tsconfig node"
Cohesion: 0.20
...
### Community 341 - "API-скрипты: Seed admin payroll preview"
Cohesion: 0.39
...
### Community 342 - "Тесты: Audit email shrink"
Cohesion: 0.36
...
### Community 343 - "Миграции: 0060 courier shift categories"
Cohesion: 0.42
...
### Community 344 - "Миграции: 0066 access rights matrix"
Cohesion: 0.42
...
### Community 345 - "Миграции: 0069 source data tab"
Cohesion: 0.44
...
### Community 346 - "Миграции: 0102 position access merge"
Cohesion: 0.39
...
### Community 347 - "Миграции: 0164 freelancer temp cards"
Cohesion: 0.36
...
### Community 348 - "Миграции: 0062 rebaseline percent coefficients"
Cohesion: 0.46
Nodes (7): date, Decimal, Table, _category_coefficient_table(), downgrade(), _replace_coefficients(), upgrade()

### Community 349 - "API-скрипты: Reclassify rent article"
Cohesion: 0.39
...
### Community 350 - "Тесты: Owner review"
Cohesion: 0.54
...
### Community 351 - "Фронт-страницы: Schedule"
Cohesion: 0.29
...
### Community 352 - "Спецификации: Sbis edo"
Cohesion: 0.25
...
### Community 354 - "API-схемы: Positions"
Cohesion: 0.29
...
### Community 355 - "Миграции: 0016 add category 4"
Cohesion: 0.46
...
### Community 356 - "Миграции: 0019 taxonomy align"
Cohesion: 0.43
...
### Community 357 - "Миграции: 0048 dds seed"
Cohesion: 0.39
...
### Community 358 - "Миграции: 0067 staff history permissions"
Cohesion: 0.46
...
### Community 359 - "Миграции: 0100 position registry"
Cohesion: 0.43
...
### Community 360 - "API-сервисы: Advance iiko payout"
Cohesion: 0.38
Nodes (6): date, Decimal, UUID, post_advance_payout_to_iiko(), Выдача аванса/займа сотруднику в iiko — изъятие из «Главной кассы».  ТК Черников, Провести выдачу аванса/займа изъятием в iiko. Ошибку логирует, не поднимает.

### Community 361 - "API-сервисы: Payout"
Cohesion: 0.29
...
### Community 362 - "Тесты: New payment context api"
Cohesion: 0.43
...
### Community 363 - "Тесты: Classifier"
Cohesion: 0.52
...
### Community 364 - "Тесты: Credentials crud"
Cohesion: 0.43
...
### Community 365 - "Исследования: Payroll calculator analysis"
Cohesion: 0.29
...
### Community 366 - "Документация: Recon shift ledger schedule"
Cohesion: 0.33
...
### Community 367 - "Документация: Access rights matrix"
Cohesion: 0.33
...
### Community 368 - "Спецификации: Payment calendar"
Cohesion: 0.29
...
### Community 369 - "business-docs: Strategy worklog"
Cohesion: 0.29
...
### Community 370 - "Деплой: Create local db dump"
Cohesion: 0.62
...
### Community 371 - "Фронт-страницы: Schedule"
Cohesion: 0.29
...
### Community 378 - "Миграции: 0071 drop production umbrella"
Cohesion: 0.52
Nodes (5): _drop_stale_permissions(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 379 - "Миграции: 0119 kassa permissions"
Cohesion: 0.48
...
### Community 380 - "Миграции: 0135 deposit rbac"
Cohesion: 0.48
...
### Community 381 - "Миграции: 0153 employee payout"
Cohesion: 0.48
...
### Community 388 - "Тесты: Freelancer temp cards"
Cohesion: 0.53
Nodes (4): Any, MonkeyPatch, IikoEmployeeCreateResult, IikoEmployeeUpdateResult

### Community 389 - "Спецификации: Telephony"
Cohesion: 0.33
...
### Community 390 - "Интеграции: Ocr image macos"
Cohesion: 0.33
Nodes (5): Foundation, Never, fail(), String, Vision

### Community 391 - "Фронт-страницы: Schedule"
Cohesion: 0.33
...
### Community 393 - "Фронт-тесты: Daily ledger collapsed days"
Cohesion: 0.40
Nodes (3): corsHeaders(), days, fulfillJson()

### Community 396 - "tmp: Suggest iiko matches"
Cohesion: 0.73
Nodes (5): deduplicate(), main(), normalize(), preferred_types(), score()

### Community 397 - "Миграции: 0001 core domain"
Cohesion: 0.47
...
### Community 398 - "Миграции: 0011 percent methodology"
Cohesion: 0.53
Nodes (4): _seed_category_coefficients(), _seed_revenue_tiers(), _sql_values(), upgrade()

### Community 399 - "Миграции: 0056 courier backend"
Cohesion: 0.47
...
### Community 400 - "Миграции: 0074 payroll payouts"
Cohesion: 0.53
Nodes (4): _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 401 - "Миграции: 0087 admin payroll permissions"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 402 - "Миграции: 0090 advance permissions"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 403 - "Миграции: 0093 counterparty permissions"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 404 - "Миграции: 0103 auxiliary create permission"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 405 - "Миграции: 0117 invoice permissions"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 406 - "Миграции: 0136 kassa invoice push"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 407 - "Миграции: 0149 revision item adjustment"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 408 - "Миграции: 0151 advance backdate permission"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 409 - "Миграции: 0159 kassa journal payout"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 410 - "Миграции: 0171 courier deposit delete"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 411 - "Миграции: 0174 deposit target floor"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 412 - "Миграции: 0178 invoice edit paid"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 413 - "Миграции: 0184 invoice price control"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 414 - "Миграции: 0190 supplier service periods"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 415 - "Миграции: 0209 location registry"
Cohesion: 0.60
Nodes (5): downgrade(), _grant_permissions(), _sql_values(), upgrade(), _upsert_permissions()

### Community 416 - "Миграции: 0015 fix category 2"
Cohesion: 0.60
Nodes (4): Table, _category_coefficient_table(), downgrade(), upgrade()

### Community 417 - "Миграции: 0036 seniority allowance fixed"
Cohesion: 0.50
Nodes (3): Connection, _raise_employee_conflicts(), upgrade()

### Community 418 - "Деплой: Pg restore"
Cohesion: 0.80
Nodes (4): confirm_restore(), log(), usage(), pg_restore.sh script

### Community 419 - "apps: Registry"
Cohesion: 0.50
Nodes (3): IntegrationDefinition, list_integration_definitions(), integration_definitions()

### Community 420 - "Исследования: Starter revenue commission 2026"
Cohesion: 0.40
...
### Community 421 - "business-docs: Payroll policy"
Cohesion: 0.40
...
### Community 432 - "Миграции: 0121 kassa shortage penalty"
Cohesion: 0.60
Nodes (3): _grant_waive_permission(), upgrade(), _upsert_permissions()

### Community 433 - "Миграции: 0203 merge heads"
Cohesion: 0.40
Nodes (4): downgrade(), Слияние линий — схему не трогаем., Разделение линий обратно — схему не трогаем., upgrade()

### Community 434 - "Миграции: 0208 merge fund iiko"
Cohesion: 0.40
Nodes (4): downgrade(), Слияние линий — схему не трогаем., Разделение линий обратно — схему не трогаем., upgrade()

### Community 435 - "apps: Package"
Cohesion: 0.40
Nodes (4): name, private, type, version

### Community 437 - "API-джобы: Employee sync job"
Cohesion: 0.67
Nodes (3): _run(), run_employee_sync_job(), SyncResult

### Community 438 - "API-джобы: Supplier closing activation job"
Cohesion: 0.67
...
### Community 440 - "Деплой: LOCAL TO PROD DB"
Cohesion: 0.50
...
### Community 452 - "Миграции: 0029 accumulation fund transactions"
Cohesion: 0.83
Nodes (3): downgrade(), upgrade(), _upsert_fund_tiers()

### Community 460 - "Миграции: 0167 sber safe payout"
Cohesion: 0.83
...
## Knowledge Gaps
- **1102 isolated node(s):** `Table`, `RowMapping`, `Connection`, `date`, `AsyncSession` (+1097 more)
...
- **Why does `async_session_factory()` connect `Тесты: правка оплаченных накладных` to `Тесты: ЗП и авторизация`, `Тесты: Payroll admin`, `Тесты: расчёт строк ЗП`, `API: Гашение бартера`, `Тесты: «Новый платёж» и Сейф`, `API: Касса — недостачи и смены`, `Тесты: Counterparties`, `Тесты: Invoice sync`, `API-сервисы: Warehouse invoices`, `API: Расчёт внештатных смен`, `API: Реестр контрагентов`, `Тесты: статусы банк-платежей`, `Тесты: Payroll pool payout`, `API-сервисы: Shift ledger`, `Тесты: Kassa cheques`, `API-сервисы: Services`, `API-сервисы: Payroll payments`, `Тесты: Dz kz canon`, `API-сервисы: Warehouse payments`, `Тесты: Barter money settlement`, `API-сервисы: Shift schedule service`, `API-сервисы: Counterparties`, `API-сервисы: Counterparties`, `Тесты: Employee payouts`, `Тесты: Payroll advance service`, `API-сервисы: Payins`, `API-сервисы: Counterparty payments`, `Тесты: Sbis sync`, `Тесты: сплит операций и дедуп`, `Тесты: Fixed assets`, `Тесты: Kassa cheque refund`, `Тесты: Barter scenarios`, `Тесты: Kassa target stage3`, `Тесты: Iiko payment verify`, `API-скрипты: Scripts`, `Тесты: Bank payment status`, `Тесты: Iiko unsettled sweep`, `Тесты: Freelancer temp cards`, `Тесты: Kassa payouts`, `API-сервисы: Deposit schedule`, `Тесты: Kassa invoice mirror`, `Тесты: Inventory audit`, `Тесты: Iiko invoice mirror`, `Тесты: Operation split card match`, `Тесты: Payroll advance bank`, `API-сервисы: Merchant rules`, `Тесты: Payroll config`, `Тесты: Payroll advance production`, `Тесты: Barter loan bank draft`, `Тесты: Warehouse push`, `Тесты: Payroll payouts`, `Тесты: Conftest`, `Тесты: Payment status poll`, `Тесты: Requisites control key`, `Тесты: Deposit bank draft`, `Тесты: Deposit full cycle`, `Тесты: Payroll payments`, `Тесты: Realtime draft settlement`, `Тесты: Audit email ingest`, `Тесты: Payroll unfinalize`, `Тесты: Absorb auto classified prebooked`, `Тесты: Amount split`, `Тесты: Reconcile prebooked`, `Тесты: Audit canon gaps`, `Тесты: Kassa pending cheque`, `Тесты: Warehouse numbering`, `Тесты: Employees`, `Тесты: Sber token refresh`, `Тесты: Iiko notfound retry`, `Тесты: Payroll advance window`, `API-сервисы: Ip card requisites`, `Тесты: Kassa cheque payout`, `Тесты: Payroll advance stale run`, `Тесты: Admin payout split`, `Тесты: Warehouse supplier change`, `Тесты: Payroll audit`, `Тесты: Tests`, `Тесты: Audit email shrink`, `Тесты: Classifier`?**
  _High betweenness centrality (0.171) - this node is a cross-community bridge._
- **Why does `FastAPI` connect `API-сервисы: Revenue forecast service` to `API-сервисы: Common`, `API: Синхронизация курьеров iiko`, `Тесты: сотрудники и увольнение`, `Тесты: Inventory audit`, `API-сервисы: Payroll advance service`, `API: ЗП-раннер и авансы`, `Тесты: ЗП и авторизация`, `Тесты: Payroll admin`, `API-роутеры: Payment page`, `API: Роутеры кассы и чеков`, `Тесты: Evaluation service`, `API-сервисы: Vacation service`, `API: Роутер ДДС и черновики`, `API: Роутеры банка`, `API: Должности и доступы`, `API: Роутеры бартера и матчинга`, `API-роутеры: Positions`, `apps: Registry`, `API: Роутер надбавок`, `Тесты: Revenue forecast`, `API-сервисы: Schedule service`, `API-сервисы: Shift ledger`, `API-роутеры: Inventory`, `API-роутеры: Locations`, `API-роутеры: Payroll adjustments`, `API-сервисы: Deposit service`, `API-роутеры: Sbis`, `Тесты: Payroll payouts`, `API-сервисы: Evaluation service`, `API-сервисы: Deferred audit charge service`, `API-роутеры: Finance payments`, `API-сервисы: Shift schedule service`, `Тесты: Shift schedule`, `API-роутеры: Accumulation fund`, `API-роутеры: Webhooks`, `API-роутеры: Access control`, `API-сервисы: Payroll forecast run service`, `API-сервисы: Plan fact service`, `Тесты: Payroll payments`, `API-сервисы: Seniority allowance resolver`, `API-роутеры: Payroll admin`, `Тесты: Payroll unfinalize`, `Тесты: Accumulation fund admin`, `API-роутеры: Payroll config`, `API-сервисы: Staff access`, `API-роутеры: Deposits`, `API-роутеры: Auth`, `Тесты: Substitution service`, `API-роутеры: Settings`, `apps: Service`, `Тесты: Employee assignments`, `API-роутеры: Accounting suppliers`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `defaultdict` connect `API-скрипты: Reconcile legacy payroll` to `Интеграции: Export employees`, `API: План-факт и надбавки`, `Интеграции: Build cashflow`, `API-скрипты: Import staff from payroll`, `Интеграции: Build cashflow`, `Интеграции: Export pnl by preset`, `API-сервисы: Shift matching`, `Интеграции: Build operations table`, `API: Расчёт внештатных смен`, `Интеграции: Build economic block`, `Интеграции: Build counterparty dds match`, `API-сервисы: Services`, `API-роутеры: Payroll adjustments`, `API-сервисы: Deposit service`, `Исследования: Build labor costs`, `API-сервисы: Payroll advance recovery`, `API-роутеры: Access control`, `API-сервисы: Payroll forecast run service`, `API-сервисы: Plan fact service`, `Интеграции: Export ops`, `Интеграции: Build inventory results`, `Исследования: Build fixed assets balance`, `API-скрипты: Import legacy payroll`, `API-сервисы: Attendance`, `Интеграции: Build pnl from invoices`, `Исследования: Classify cashflow`, `Интеграции: Export revenue by direction`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Are the 885 inferred relationships involving `async_session_factory()` (e.g. with `test_adjust_paid_endpoint_permission_and_receivable()` and `test_book_correction_blocked_when_payment_not_in_iiko()`) actually correct?**
  _`async_session_factory()` has 885 INFERRED edges - model-reasoned connections that need verification._
- **Are the 365 inferred relationships involving `PayrollConflictError` (e.g. with `AdvanceAvailability` and `AdvanceRecoveryDeferralRequest`) actually correct?**
  _`PayrollConflictError` has 365 INFERRED edges - model-reasoned connections that need verification._
- **Are the 341 inferred relationships involving `make_counterparty()` (e.g. with `CounterpartyRole` and `_iiko_bank_paid_invoice()`) actually correct?**
  _`make_counterparty()` has 341 INFERRED edges - model-reasoned connections that need verification._
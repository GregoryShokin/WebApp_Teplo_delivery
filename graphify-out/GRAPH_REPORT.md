...
## Corpus Check
- 11 files · ~8,300,618 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18761 nodes · 60798 edges · 723 communities (661 shown, 62 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 14053 edges (avg confidence: 0.61)
...
9. `TaxPayment` - 144 edges
10. `BankFetchError` - 135 edges
...
## Communities (723 total, 62 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.00
Nodes (445): addDays(), CATEGORY_LABELS, CourierRow(), DEPOSIT_TYPE_LABELS, DepositDialog(), formatDayLabel(), formatScore(), formatTime() (+437 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (351): addCollectionSource(), addRoutingRule(), archiveCounterparty(), autoSettleBarter(), BankPrepaymentDraftPayload, BarterDetail, BarterInvoice, BarterSettlementView (+343 more)
...
Cohesion: 0.02
Nodes (174): CourierDeliveriesTab(), formatDateTime(), formatRubles(), presetRange(), RangePreset, addDays(), cellClass(), cellTitle() (+166 more)
...
Cohesion: 0.02
Nodes (170): Курьеры — оценки админов (MVP), 14 критериев courier_evaluation_criterion с баллами, Депозитный счёт курьера: цель 5000₽, удержания 500/200, CourierDepositsRouteProps, CourierOperationDialog(), depositGroupRank(), isDepositCollected(), LastOperation() (+162 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (161): AccountingItem, AccountingList, ALLOCATION_LABEL, BalanceList, BalancesSection(), CounterpartyBalance, date, DocumentAllocationRef (+153 more)
...
Cohesion: 0.03
Nodes (152): EmployeeRoleAssignment, AsyncSession, date, TaxPayment, AsyncSession, date, Decimal, TaxInputs (+144 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (143): AdvanceAvailability, alias, AsyncSession, CurrentActor, date, Depends, Employee, get_current_actor (+135 more)

### Community 13 - "Community 13"
Cohesion: 0.18
Nodes (138): AdvanceRecoveryDeferralRequest, date, EmployeePayoutRead, PayrollLineRead, PayrollRunCreate, alias, Any, AsyncSession (+130 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (127): AsyncSession, IikoProduct, async_sessionmaker, AsyncSession, async_sessionmaker, AsyncSession, async_sessionmaker, AsyncSession (+119 more)
...
Cohesion: 0.04
Nodes (116): Account, Any, async_sessionmaker, AsyncSession, BankOperation, CounterpartyRoutingRule, date, datetime (+108 more)

### Community 17 - "Community 17"
Cohesion: 0.17
Nodes (116): AiAuditReportRead, AiDocumentReviewRead, alias, AsyncSession, BankFetchError, CurrentActor, date, Depends (+108 more)
...
Cohesion: 0.06
Nodes (113): AsyncSession, date, Decimal, async_sessionmaker, AsyncSession, date, datetime, TaxDocumentIntake (+105 more)
...
Cohesion: 0.05
Nodes (102): Any, AsyncSession, BankOperation, datetime, Decimal, SupplierInvoice, UUID, Any (+94 more)
...
Cohesion: 0.07
Nodes (94): Any, AsyncSession, date, datetime, Element, Employee, Exception, ModuleType (+86 more)
...
Cohesion: 0.03
Nodes (69): addDaysInput(), CourierEvaluationsRoute(), CourierOption, editCountdownText(), emptyForm(), EvaluationCard(), EvaluationFormSheet(), EvaluationFormState (+61 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (90): AsyncSession, date, UUID, CounterpartyPaymentDraft, SupplierInvoice, async_sessionmaker, AsyncSession, async_sessionmaker (+82 more)
...
Cohesion: 0.06
Nodes (73): AsyncSession, Counterparty, Depends, get_session, Response, SbisDocument, SupplierInvoice, UUID (+65 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (87): AsyncSession, PayrollPeriod, Counterparty, async_sessionmaker, AsyncSession, async_sessionmaker, AsyncSession, CashflowTransaction (+79 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (82): Base, Location, Permission, Помещение (филиал, склад, офис) — ось аналитики «где» и точка привязки к iiko., Role, RolePermission, RolePermissionEvent, User (+74 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (80): toDateTimeLocalInput(), cancelKassaAdvancePermission(), CardTransaction, Cheque, ChequeAllocation, ChequeLine, ChequeLinePayload, createCheque() (+72 more)
...
Cohesion: 0.05
Nodes (83): Namespace, AsyncSession, AsyncSession, date, Decimal, UUID, async_sessionmaker, AsyncSession (+75 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (86): Any, AsyncSession, date, Decimal, Employee, PayrollLine, PayrollPeriod, PayrollRun (+78 more)
...
Cohesion: 0.05
Nodes (73): Namespace, AsyncSession, date, Decimal, AsyncSession, date, Decimal, async_sessionmaker (+65 more)
...
Cohesion: 0.07
Nodes (80): AsyncSession, BankOperation, date, Decimal, SafeAllocation, UUID, Wallet, async_sessionmaker (+72 more)
...
Cohesion: 0.05
Nodes (76): date, Decimal, date, clamp(), compute_tax_state(), _fingerprint(), fixed_contribution_due(), money() (+68 more)
...
Cohesion: 0.05
Nodes (66): Account, _account_for_number(), _account_for_operation(), archive_expired_freelancer_cards(), auto_commit_shift_schedule_job(), _bank_operation_from_normalized(), _bank_sync_providers(), _claim_seed_account() (+58 more)

### Community 65 - "Community 65"
Cohesion: 0.04
Nodes (59): createBankPrepaymentDraft(), createPrepayment(), AdvanceForm(), amountOf(), amountStr(), dateInput(), defaultServicePeriod(), DIRTY_LABELS (+51 more)
...
Cohesion: 0.10
Nodes (61): Any, AsyncSession, date, datetime, DdsArticle, Decimal, IikoProduct, InvoiceLineItem (+53 more)
...
Cohesion: 0.13
Nodes (57): async_sessionmaker, AsyncSession, cloud_invoice_docs(), Build a ``/suppliers`` XML payload. Each dict: id, name, inn, deleted,     repre, Cloud JSON-документы (incoming) в форме ответа ``incoming_invoice/get``.      Ea, suppliers_xml(), Реверс-синк iiko не переписывает сумму бартерного займа.      Состав займа замор, test_iiko_resync_does_not_rewrite_barter_loan_amount() (+49 more)
...
Cohesion: 0.08
Nodes (53): AsyncSession, BankOperation, date, Decimal, TaxBankDraft, TaxPayment, _amounts_match(), _build_rows() (+45 more)
...
Cohesion: 0.12
Nodes (52): IikoProduct, InvoiceLineItem, SupplierInvoice, async_sessionmaker, AsyncSession, Decimal, IikoProduct, InvoiceLineItem (+44 more)
...
Cohesion: 0.09
Nodes (45): SupplierInvoice, async_sessionmaker, AsyncSession, InvoiceLineItem, IikoProduct, InvoiceLineItem, SupplierInvoice, SafeAllocation (+37 more)

### Community 115 - "Community 115"
Cohesion: 0.12
Nodes (46): async_sessionmaker, AsyncSession, Decimal, UUID, _make_loan(), _product(), Денежное гашение бартерных займов — целевой процесс владельца (18.07.2026).  Дол, Правило владельца: выдали по 300, вернули товаром при рынке 350 → приход по 300. (+38 more)
...
Cohesion: 0.17
Nodes (42): AsyncSession, Decimal, PayrollRun, SafeAllocation, UUID, _active_run_reserve(), _add_pool_payout_event(), _add_reserve_cancel_event() (+34 more)
...
Cohesion: 0.25
Nodes (37): CurrentActor, ensure_any_permission(), require_finance_manager_plus(), require_manager_plus(), AsyncSession, CurrentActor, date, Depends (+29 more)
...
Cohesion: 0.19
Nodes (38): AsyncSession, CurrentActor, Depends, get_current_actor, get_session, UUID, AdminExclusionRead, AdminExclusionUpsert (+30 more)
...
Cohesion: 0.12
Nodes (34): AsyncSession, date, TaxPayment, async_sessionmaker, AsyncSession, date, TaxPayment, _injury_month_covered() (+26 more)
...
Cohesion: 0.10
Nodes (27): apiErrorStatus(), cancelVacationPeriod(), createVacationPeriod(), getVacationPayoutDates(), getVacationRoster(), patchVacationPeriod(), VacationConflictResponse, VacationPeriodRead (+19 more)
...
Cohesion: 0.14
Nodes (24): _default_permissions_for_header_roles(), get_current_actor(), _split_roles(), AsyncSession, Depends, get_session, Header, AsyncSession (+16 more)
...
Cohesion: 0.20
Nodes (25): Any, AsyncSession, BankOperation, date, Decimal, SupplierInvoice, UUID, CashflowTransaction (+17 more)
...
- **Why does `async_session_factory()` connect `Community 14` to `Community 16`, `Community 18`, `Community 21`, `Community 22`, `Community 25`, `Community 26`, `Community 27`, `Community 32`, `Community 33`, `Community 34`, `Community 37`, `Community 45`, `Community 47`, `Community 48`, `Community 54`, `Community 56`, `Community 59`, `Community 71`, `Community 73`, `Community 77`, `Community 78`, `Community 81`, `Community 83`, `Community 88`, `Community 96`, `Community 105`, `Community 110`, `Community 111`, `Community 114`, `Community 115`, `Community 117`, `Community 136`, `Community 138`, `Community 140`, `Community 143`, `Community 157`, `Community 159`, `Community 161`, `Community 162`, `Community 166`, `Community 173`, `Community 179`, `Community 181`, `Community 188`, `Community 196`, `Community 221`, `Community 227`, `Community 229`, `Community 236`, `Community 238`, `Community 240`, `Community 241`, `Community 242`, `Community 248`, `Community 252`, `Community 253`, `Community 256`, `Community 264`, `Community 273`, `Community 280`, `Community 284`, `Community 286`, `Community 288`, `Community 289`, `Community 301`, `Community 302`, `Community 306`, `Community 312`, `Community 317`, `Community 321`, `Community 324`, `Community 331`, `Community 333`, `Community 368`, `Community 381`, `Community 391`, `Community 402`, `Community 404`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
- **Why does `FastAPI` connect `Community 219` to `Community 132`, `Community 260`, `Community 134`, `Community 263`, `Community 9`, `Community 10`, `Community 139`, `Community 12`, `Community 269`, `Community 13`, `Community 272`, `Community 17`, `Community 18`, `Community 147`, `Community 20`, `Community 277`, `Community 149`, `Community 151`, `Community 24`, `Community 26`, `Community 35`, `Community 36`, `Community 163`, `Community 425`, `Community 41`, `Community 175`, `Community 308`, `Community 54`, `Community 55`, `Community 183`, `Community 57`, `Community 186`, `Community 58`, `Community 61`, `Community 62`, `Community 71`, `Community 72`, `Community 199`, `Community 459`, `Community 208`, `Community 209`, `Community 212`, `Community 218`, `Community 220`, `Community 97`, `Community 356`, `Community 228`, `Community 103`, `Community 233`, `Community 113`, `Community 242`, `Community 116`, `Community 244`, `Community 248`, `Community 122`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `HTTPException` connect `Community 13` to `Community 134`, `Community 135`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 17`, `Community 147`, `Community 20`, `Community 35`, `Community 36`, `Community 41`, `Community 57`, `Community 61`, `Community 71`, `Community 72`, `Community 458`, `Community 93`, `Community 228`, `Community 116`, `Community 122`?**

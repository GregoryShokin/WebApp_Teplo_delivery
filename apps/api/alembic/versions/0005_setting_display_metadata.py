...
SETTING_DISPLAY_METADATA = {
    "schedule.target_payroll_revenue_ratio": {
        ...
        "description": ("Целевая доля ФОТ в выручке для планирования графика."),
        "widget_type": "percent",
        "widget_options": None,
        "unit": "%",
    },
    "schedule.payroll_plan_fact_deviation_threshold": {
        ...
        "description": ("Отклонение от планового ФОТ, после которого смена требует внимания."),
        "widget_type": "percent",
        "widget_options": None,
        "unit": "%",
    },
    "schedule.atypical_days": {
        ...
        "description": ("Даты и периоды с нетиповым прогнозом выручки и графика."),
    ...
    "payroll.open_shift_cap_hours": {
        ...
        "description": ("Лимит часов для открытой смены перед авто-закрытием."),
        "widget_type": "number",
    ...
    "payroll.open_shift_auto_close_time": {
        ...
        "description": ("Время по Москве для закрытия смены без отметки окончания."),
        "widget_type": "time",
        "widget_options": None,
        "unit": None,
    },
    "payroll.weekly_payment_window": {
        ...
        "description": ("День, с которого начинается расчётная неделя зарплаты."),
        "widget_type": "select",
        "widget_options": {
            "options": [
                {
    ...
    "payroll.deposit_fund_payment_date": {
        ...
        "description": ("Ежегодная дата выплаты накопительного фонда сотрудникам."),
        "widget_type": "date",
        "widget_options": {"format": "MM-DD", "fixed_year": False},
        "unit": None,
    },
    "payroll.role_category_rates": {
        ...
        "description": ("Базовые ставки полной 12-часовой смены по роли и категории."),
        "widget_type": "json",
        "widget_options": None,
        "unit": "₽",
    },
    "payroll.category_rules": {
        ...
        "description": ("Коэффициенты процента, депозитная цель и удержание по категориям."),
        "widget_type": "json",
        "widget_options": None,
        "unit": None,
    },
    ...
    "payroll.allowances": {
        ...
        "description": ("Доплаты старшему и заместителю старшего за смену."),
        "widget_type": "json",
        "widget_options": None,
        "unit": "₽",
    },
    ...
    "payroll.mock_daily_revenue": {
        ...
        "description": ("Ручной источник дневной выручки до подключения iiko OLAP."),
        "widget_type": "json",
        "widget_options": None,
        "unit": "₽",
    },
    "payroll.deposit_auto_withholding_enabled": {
        ...
        "description": ("Включает автоматическое удержание депозита по категории."),
        "widget_type": "boolean",
        "widget_options": None,
        "unit": None,
    },
    "payroll.deposit_write_offs": {
        ...
        "description": ("Списания депозитов до отдельного журнала payroll-событий."),
        "widget_type": "json",
        "widget_options": None,
        "unit": "₽",
    },
    "payment_calendar.auto_match_tolerance": {
        ...
        "description": ("Допустимое отклонение суммы при сопоставлении план/факт ДДС."),
        "widget_type": "percent",
    ...
    "payment_calendar.revenue_seasonality_coefficients": {
        ...
        "description": ("Коэффициенты сезонности для прогноза выручки."),
        "widget_type": "json",
        "widget_options": None,
        "unit": None,
    },
    "balance.close_day": {
        ...
        "description": ("Последний день месяца, до которого нужно закрыть баланс."),
        "widget_type": "number",
    ...
    "fixed_assets.capitalization_threshold_rub": {
        ...
        "description": ("Минимальная стоимость актива для признания основным средством."),
        "widget_type": "number",
    ...
    "fixed_assets.repair_modernization_threshold_ratio": {
        ...
        "description": ("Доля стоимости, отделяющая ремонт от модернизации."),
        "widget_type": "percent",
        "widget_options": None,
        "unit": "%",
    },

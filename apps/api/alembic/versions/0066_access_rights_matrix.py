"""sync access rights matrix permissions

Revision ID: 0066_access_rights_matrix
Revises: 0065_access_audit
...
revision = "0066_access_rights_matrix"
down_revision = "0065_access_audit"
branch_labels = None
depends_on = None
...
def _update_role_names() -> None:
    op.execute("update role set name = 'Офис-менеджер' where code = 'office_manager'")
    op.execute("update role set name = 'Кассир' where code = 'cashier'")

...
LINES: list[tuple] = [
    ...
    (
        "revenue_gross_gagarina",
        "Выручка без учета скидок Гагарина",
        "revenue",
        "memo",
        20,
        1,
    ...
    (
        "revenue_net_gagarina",
        "Выручка с учетом скидок Гагарина",
        "revenue",
        "source",
        30,
        1,
    ...
    (
        "revenue_net_chernikova",
        "Выручка с учетом скидок Черникова",
        "revenue",
        "source",
        50,
        1,
    ...
    (
        ...
        False,
        "active",
        {"op": "sum", "args": ["variable_costs", "direct_fixed", "overhead"]},
        0.700,
        0.800,
    ...
    (
        ...
        True,
        "active",
        {"op": "sum", "block": "variable"},
        None,
        None,
        "Фудкост",
    ),
    (
        "food_cost_chernikova",
    ...
    (
        ...
        True,
        "active",
        {"op": "sub", "args": ["revenue", "variable_costs"]},
        None,
        None,
    ...
    (
        ...
        False,
        "active",
        {"op": "ratio", "num": "margin_income", "den": "revenue"},
        0.600,
        0.700,
        None,
    ),
    ...
    (
        ...
        True,
        "active",
        {"op": "sub", "args": ["margin_income", "direct_fixed"]},
        None,
        None,
        None,
    ),
    (
        "gross_profit_by_direction_ratio",
        ...
        False,
        "active",
        {"op": "ratio", "num": "gross_profit_by_direction", "den": "revenue"},
        None,
        None,
        None,
    ),
    ...
    (
        ...
        False,
        "active",
        {"op": "sub", "args": ["gross_profit_by_direction", "overhead"]},
        None,
        None,
        None,
    ),
    (
        ...
        False,
        "active",
        {"op": "ratio", "num": "gross_profit", "den": "revenue"},
        0.120,
        0.250,
        None,
    ),
    ...
    (
        ...
        False,
        "active",
        {"op": "sum", "args": ["admin_costs", "commercial_costs"]},
        None,
        None,
        None,
    ),
    ...
    (
        ...
        False,
        "active",
        {"op": "sub", "args": ["gross_profit", "indirect_costs"]},
        None,
        None,
        None,
    ),
    (
        ...
        False,
        "active",
        {"op": "ratio", "num": "ebitda", "den": "revenue"},
        0.030,
        0.070,
        None,
    ),
    ...
    (
        ...
        None,
        None,
        "ДДС, прочие поступления",
    ),
    (
        "unclaimed_deposits_writeoff",
        "Списание невостребованных депозитов",
        "below_income",
        "source",
        640,
        1,
    ...
    (
        ...
        None,
        None,
        "EBITDA плюс доходы ниже EBITDA минус расходы ниже EBITDA",
    ),
    (
        "net_profit_ratio",
        ...
        False,
        "active",
        {"op": "ratio", "num": "net_profit", "den": "revenue"},
        None,
        None,
        None,
    ),
    ...
    (
        "__accrual_settled__",
        "Исключено как расчёт по признанию",
        "service",
        "service",
        920,
        0,
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("direction_aware", sa.Boolean, nullable=False, server_default=sa.text("false")),

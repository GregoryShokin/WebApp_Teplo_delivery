...
def _to_read(doc: SbisDocument, invoice: SupplierInvoice | None) -> SbisDocumentRead:
    return SbisDocumentRead(
        ...
        matched_invoice=MatchedInvoiceRead.model_validate(invoice) if invoice else None,
...
async def list_documents(
    ...
    query = (
        ...
        .outerjoin(SupplierInvoice, SupplierInvoice.id == SbisDocument.matched_invoice_id)
    ...
    return [_to_read(doc, invoice) for doc, invoice in rows]

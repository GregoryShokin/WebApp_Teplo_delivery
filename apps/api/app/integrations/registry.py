...
def list_integration_definitions() -> list[IntegrationDefinition]:
    return [
        IntegrationDefinition(
            ...
            pattern="direct_api",
            script_path="research/scripts/iiko",
        ...
        IntegrationDefinition(
            ...
            name="Sber Business",
            pattern="direct_api",
            script_path="research/scripts/sber",
            status="existing_python_scripts",
        ),
        IntegrationDefinition(
            code="tbank",
            ...
            pattern="direct_api",
            script_path="research/scripts/tbank",
            status="existing_python_scripts",
        ),
        IntegrationDefinition(
            code="mailru",
            ...
            script_path="research/scripts/mail",
            status="existing_python_scripts",
        ),
        IntegrationDefinition(
            code="mango",
            ...
            script_path="research/scripts/mango",
            status="existing_python_scripts",
        ),
        IntegrationDefinition(
            ...
            script_path="research/scripts/tbank/payment_order_bot.py",

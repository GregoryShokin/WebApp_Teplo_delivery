...
Источник — «Реестр_ОС_и_амортизация_2026-08-01.xlsx», лист «Реестр ОС»: 110 позиций,
149 единиц, 2 313 150 ₽, единая дата ввода 01.08.2026. Реестр собран по фотофиксации
...
def read_units(path: Path) -> list[Unit]:
    ...
    for row in sheet.iter_rows(min_row=2, values_only=True):
        ...
        status = "not_working" if type_name == NOT_WORKING_TYPE else "in_use"

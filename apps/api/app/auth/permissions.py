...
VISIBLE_PERMISSION_CATALOG: tuple[PermissionCatalogItem, ...] = (
    ...
    ("staff.production.read", "Штат", "Смотреть производственный персонал"),
    ("staff.production.edit", "Штат", "Редактировать производственный персонал"),
    (
        "staff.production.assign_roles_categories",
        "Штат",
        "Назначать роли и категории производственного персонала",
    ),
    (
        "staff.production.assign_allowances",
        "Штат",
        "Назначать надбавки производственного персонала",
    ),
    ("staff.production.dismiss", "Штат", "Увольнять производственный персонал"),
    ("staff.production.reinstate", "Штат", "Восстанавливать производственный персонал"),
    (
        "staff.production.history.read",
        "Штат",
        "Смотреть историю изменений производственного персонала",
    ),

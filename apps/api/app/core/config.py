...
class Settings(BaseSettings):
    ...
    # Кому разрешено присылать документы: id чатов через запятую. Пусто — бот не принимает
    # НИКОГО и в ответ называет собеседнику его chat id. Иначе любой, кто нашёл бота по имени,
    # заводил бы в учёте документы: токен бота секретом не является, имя бота публично.
    telegram_intake_allowed_chat_ids: str = ""

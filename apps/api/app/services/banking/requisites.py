...
# Минимальный набор для платёжного поручения официальному поставщику: без любого из
# четырёх банк платёжку не примет. Живёт здесь, а не в реестре контрагентов, потому что
# на него смотрят трое: реестр (гард «нельзя подтвердить неполные»), аренда помещений
# (тот же набор у арендодателя) и поиск реквизитов в истории (полнота кандидата).

...
ЧЕГО ЗДЕСЬ НЕТ. Сшивки пары «факт + аванс» в один платёж: она требует хранилища (два акта
приходят разными файлами) и живёт выше — в том слое, который вызывает распознавание.
"""

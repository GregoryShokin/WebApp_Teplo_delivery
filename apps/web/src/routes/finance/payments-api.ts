...
export type PaymentRow = {
  ...
  source:
    ...
    | "employee_payout"
    // Налоговая платёжка (модуль «Налоги»): черновик в банк по обязательству сверки.
    | "tax_draft"
    // Виртуальное «к уплате» из налогового контура: черновика ещё нет, создаётся по кнопке.
    | "tax_due";
  kind: string;
  ref_id: string;
  title: string;

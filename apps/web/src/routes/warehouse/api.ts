...
export type LinePayload = {
  ...
  is_staff: boolean;
  dds_article_id?: string | null;
  // Позиция возвращена в магазин (чек Кассы): остаётся в документе, но не проводится.
  // При правке чека флаг обязан уехать обратно — иначе возврат станет проведённой покупкой.
  is_return?: boolean;

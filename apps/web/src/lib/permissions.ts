...
const SECTION_PERMISSIONS: Record<AppSection, readonly PermissionCode[]> = {
  ...
  "payroll.audits": ["payroll.revisions.read", "accounting.audits.read"],
...
const ACTION_PERMISSIONS: Record<AppAction, readonly PermissionCode[]> = {
  ...
  "payroll.source-data.edit": ["payroll.source_data.edit", "payroll.rules.configure"],
...
const LEGACY_PERMISSION_ALIASES: Record<PermissionCode, readonly PermissionCode[]> = {
  ...
  "inventory.read": ["accounting.inventory.read", "accounting.audits.read"],
  "inventory.write": ["accounting.inventory_directory.edit", "accounting.inventory.conduct"],

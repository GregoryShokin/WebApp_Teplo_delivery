...
- compose: `teplo-employee-balance` (web 5203 / api 8050 / pg 5482)
- трогает: превью зарплатного баланса сотрудников в «Учёте ДЗ/КЗ»
- НЕ трогать другим: контейнеры/порты превью до завершения просмотра пользователем
- статус: превью запущено по запросу пользователя

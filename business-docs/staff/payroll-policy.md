...
Производственные ставки и исключения описаны в `/app-spec/modules/staff/payroll/production/spec.md`. Бизнес-политика ревизий остаётся owner-review: нужно подтвердить периодичность, exclusion flag и P&L treatment перед тем, как считать её стабильной.
